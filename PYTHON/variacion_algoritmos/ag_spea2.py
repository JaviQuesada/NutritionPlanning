...
def restriccion_macronutrientes (calorias_diarias, proteinas_diarias, carbohidratos_diarias, grasas_diarias):
    ...
    if porcentaje_proteinas < LIMITE_PROTEINAS[0] or porcentaje_proteinas > LIMITE_PROTEINAS[1]:
        penalizacion_macronutrientes += 1
...
class PlanningComida(ElementwiseProblem):
        ...
        def _evaluate(self, x, out, *args, **kwargs):
            ...
            for dia in range(NUM_DIAS):
                ...
                for indice_comida, comida in enumerate(COMIDAS):
                    ...
                    for indice_alimento in range(num_alimentos):
                        ...
                        total_penalizaciones_alergia += restriccion_alergia(alimento, self.grupo_alergia)
            ...
            out["G"] = np.array([fitness_restriccion_alergia, fitness_restriccion_calorias, fitness_restriccion_macronutrientes])
...
def ejecutar_algoritmo_genetico(comida_basedatos, objetivo_calorico, grupo_gusta, grupo_no_gusta, grupo_alergia):
    ...
    algoritmo = SPEA2(
        ...
        mutation=CustomMutation(problema, prob_mutation=1/77),  # Mutacion
