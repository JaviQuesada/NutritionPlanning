    ...
    for sujeto_id, seeds in soluciones_por_seed.items():
        ...
        for seed in seeds:
            ...
            if soluciones is not None and len(soluciones) > 0:
                ...
                hipervolumen_actual = calculo_hv.do(soluciones_no_dominadas) if len(soluciones_no_dominadas) > 0 else None
            else:
...
def main():
    ...
    accion = input("¿Que acción realizar? (1: Calcular punto de referencia, 2: Calcular hipervolumen por seed): ")
