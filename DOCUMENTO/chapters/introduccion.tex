...
En el capítulo \ref{ch:experimentacion}, \nameref{ch:experimentacion}, se realizan análisis de sensibilidad, cálculos de hipervolumenes y comparaciones entre los diferentes algoritmos genéticos utilizados, además de documentar los resultados. Estas pruebas permiten evaluar y comparar el rendimiento y la eficiencia de los algoritmos.
